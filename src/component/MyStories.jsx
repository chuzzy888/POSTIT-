...
function MyStories() {
    return (
        <div>
            ...
            <div className='flex justify-between ml-20 mr-20 items-center mt-5 flex-col lg:flex-row'>
                ...
                <div>
                    <Link to="/create">
                        <button className='bg-black text-white lg:p-2 lg:px-3 rounded p-1 px-2 text-xs lg:text-sm'>Write Story</button>
                    </Link>
                </div>
            </div>
            ...
            <div className='flex justify-around items-center mb-4 flex-col lg:flex-row'>
                <div className='w-full lg:w-1/2 flex flex-col gap-3 lg:items-start'>
                    <h1 className='text-center lg:text-left'>The 20 Biggest Fintech Companies In Nigeria 2022</h1>
                    <div>
                ...
                <div className='flex gap-3 mb-40 justify-center lg:justify-end'>
                    <Link to="/update">
                        <button className='bg-blue-500 p-2 text-white px-4 rounded'>Edit Post</button>
                    </Link>
                    <button className='border-4 border-blue-100 hover:bg-red-800 hover:text-white p-2 text-blue-500 px-4 rounded'>Delete</button>
                </div>
            </div>
